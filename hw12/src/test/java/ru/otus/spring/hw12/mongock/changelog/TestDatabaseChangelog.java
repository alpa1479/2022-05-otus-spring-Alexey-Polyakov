package ru.otus.spring.hw12.mongock.changelog;

import com.github.cloudyrock.mongock.ChangeLog;
import com.github.cloudyrock.mongock.ChangeSet;
import com.mongodb.client.MongoDatabase;
import ru.otus.spring.hw12.domain.*;
import ru.otus.spring.hw12.repository.*;
...
public class TestDatabaseChangelog {
    ...
    @ChangeSet(order = "009", id = "saveUsers", author = "alpa")
    public void saveUsers(UserRepository userRepository) {
        userRepository.saveAll(of(
                // Decoded password: pwd
                new User("user1", "$2a$10$Bj2vYEtYF7GuliGQ5FVOsOeYE0I/eP35L65GAAxx4I685FoaXJ1RG"),
                new User("user2", "$2a$10$Bj2vYEtYF7GuliGQ5FVOsOeYE0I/eP35L65GAAxx4I685FoaXJ1RG"),
                new User("user3", "$2a$10$Bj2vYEtYF7GuliGQ5FVOsOeYE0I/eP35L65GAAxx4I685FoaXJ1RG")
        ));
    }
